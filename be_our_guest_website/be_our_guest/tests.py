...
import jwt
from be_our_guest_website.be_our_guest.models import (County, Event, User, Venue, VenueType, WeddingType)
from be_our_guest_website.be_our_guest.serializers import MyTokenObtainPairSerializer
from be_our_guest_website.be_our_guest.views import (create_event, events,
                                 get_users, get_venues, login,
                                login_view, register_user, update_event)
...
class EventCreationTestCase(TestCase):
    ...
    def test_create_event_with_numbers_in_wedding_title(self):
        ...
        data = {
            "event": {
                "title": "Wedding 123",  # Example with numbers in the title
                "date": "2024-04-15",
                "time": "18:00:00",
        ...
        print(response.data)  # Print response data for additional debugging
