                    ...
                    <div className='church-details'>
                        <div className='details-group1'>
                            ...
                            <div className='details-group1'>
                                ...
                                <input type="time" id="venue_1_time" value={eventData.time || ''} name="venue_1_time" onChange={handleChange} required className="custom-input" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className='event-details-container host-form2'>
                    <form className='host-form' onSubmit={handleSubmit}>
                        ...
                        <div className='details-group1'>
                            ...
                            <input type="time" id="time" value={eventData.venue_1_time || ''} name="time" onChange={handleChange} required className="custom-input" />
                        </div>
                        {/* Date Input */}
                        <div className='details-group1'>
